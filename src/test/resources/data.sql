...
insert into person (id,name, year_of_birthday, month_of_birthday, day_of_birthday) values (4,'sophie',1994,8,15);
insert into person (id,name, year_of_birthday, month_of_birthday, day_of_birthday) values (5,'benny',1995,12,23);
insert into person (id,name, year_of_birthday, month_of_birthday, day_of_birthday, hobby, phone_number, address)
    values(6,'tony',1991,7,10,'reading','010-2222-5555','seoul');
